...
Solving this differential equation gives the following solution:
...
\end{equation}
where the time variable $t$ now appears in $q$ $\rho$ and $p$ to signify different trajectories arriving at different times. Next we need to discretize \Cref{eq:ensemble_mix_ratio}. \textcite{seibert2004source} introduce the following discretisation:
