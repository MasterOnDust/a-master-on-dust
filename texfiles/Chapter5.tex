...
Before the inter-annual variations in the \acrshort{eadc} are examined in \Cref{sec:inter_annual_results} and how the variability in the \acrshort{eadc} is related to the large scale circulation. 
...
To give some context to the investigation of the interannual variability of the \acrshort{eadc} in \Cref{sec:inter_annual_results}. The multi-year average of dust emission, transport and deposition is examined first. 
...
The red points in \Cref{fig:dust_loading_trajecs} are spaced equally 12 hours apart and  indicate the velocity of the dust transporting air masses. 
\begin{figure}[hptb]
    \centering
...
The correlation analysis showed significant correlations between winter \acrshort{ao} and increased dust deposition at several receptor locations. 
